...
import { postDepartment, postIntroduction, putDepartment, putIntroduction } from "@/apis/introduction";
  ...
  const handleUploadImage = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (props.input.departmentId) {
        await putIntroduction(props.input.departmentId, props.input.description, image);
        console.log("업데이트 성공");
      } else {
        const response = await postIntroduction(props.input.description, image);
